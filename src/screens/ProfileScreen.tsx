...
export default function ProfileScreen({ route }: { route?: { params?: any } }) {
  ...
  useEffect(() => {
    ...
    // Extract primitive values for stability
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {statusMessage && (
        <View style={[styles.statusBanner, dynamicBannerStyle as keyof typeof styles]}>
          ...
          <Text style={[styles.statusText, dynamicTextStyle as keyof typeof styles}>{statusMessage.text}</Text>
        </View>
      )}
...
const dynamicBannerStyle = statusMessage?.type && `${statusMessage.type}Banner` in styles ? styles[`${statusMessage.type}Banner`] : undefined;
const dynamicTextStyle = statusMessage?.type && `${statusMessage.type}Text` in styles ? styles[`${statusMessage.type}Text`] : undefined;

console.log('statusMessage', statusMessage);
console.log('dynamicBannerStyle', dynamicBannerStyle);
console.log('dynamicTextStyle', dynamicTextStyle);
console.log('styles', styles);
console.log('styles.statusText', statusMessage?.text);
console.log('styles.statusText', dynamicTextStyle);
console.log('styles.statusText', statusMessage?.text);
console.log('styles.statusText', statusMessage?.text);
console.log('styles.statusText', statusMessage?.text);
console.log('styles.statusText', statusMessage?.text);
