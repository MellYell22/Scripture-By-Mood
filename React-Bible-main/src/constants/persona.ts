...
// Added logic for natural pauses and thinking dots
export const THINKING_DELAY = 2000; // 2 seconds delay for natural pacing
export const THINKING_INDICATOR = '...'; // Animated dots to simulate thoughtfulness
